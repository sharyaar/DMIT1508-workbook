...
SELECT  COUNT(CourseHours) AS 'Course Hours', AVG(CourseCost) AS 'Course Cost'
FROM    Course
...
SELECT  StaffID, AVG(Mark) AS 'Average Course Mark'
FROM    Registration
Group By StaffID
ORDER BY  Count(Mark) ASC  
